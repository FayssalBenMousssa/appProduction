...
public enum Status {
  /**
    ...
    document. This status is considered active.
    This state is usually the initial state when the editorial process requires managers and
    approvers to allocate work for the document.
